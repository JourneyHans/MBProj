...
项目已从 `Phase 1`（纯扫雷）进入 `Phase 2`（卡牌系统）并完成 MVP 闭环：
...
> 现阶段更准确定位：**Alpha 可玩版本 + 持续打磨阶段**，尚未进入 Roguelike 进度系统的实装阶段。
...
3. **文档完善**
   - 模块开发文档（已建立，持续补充）
   - Release Notes 与 Roadmap 联动更新机制
...
- `v0.2.0-alpha`：卡牌系统基础（当前开发主线）
- `v0.3.0-alpha`：Roguelike 核心（下一阶段）
