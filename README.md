...
这是一个基于 **扫雷 + 卡牌构筑** 设计的前端原型项目，当前处于 `v0.2.0-alpha` 开发阶段。
...
- `js/grid/`：扫雷逻辑与 Canvas 渲染
- `js/cards/`：卡牌数据结构、牌堆手牌、卡牌交互、效果执行
